          ...
          ?>
                  <div class="col-md-4" style="position: relative;">
                      ...
                      <div style="padding: 5px;background: #f6f5f7;border: solid 1px #e7e7e7;margin-bottom: 20px;">
                        ...
                        <h5 style="background: #fff;padding: 5px;text-align: center;margin: 5px 0;font-weight: bold;border: solid 1px #e2e0e4;"><?php echo (mb_strlen($value['title'] , 'utf8') > 35 ? mb_substr($value['title'],0,35) . ' ...' : $value['title']); ?></h5>
