      ...
      <article class="col-xs-12 col-md-12">
          ...
          <div class="col-md-4" style="position: relative;">
              ...
              <div style="padding: 5px;background: #f6f5f7;border: solid 1px #e7e7e7;margin-bottom: 20px;">
                ...
                <a href="category.php?cat="><h5 style="background: #607D8B;padding: 5px 12px;text-align: center;margin: 5px 0;border: solid 1px #546f7b;position: absolute;top: 30px;color: #fff;"><?php echo $category->getCatNameById($value['category']); ?></h5></a>
